...
/**
 * Halaman untuk menambah pelanggan baru dengan desain yang lebih modern.
 */
function CreateCustomerPage() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (error.response && error.response.status === 422) {
                ...
                console.error("Terjadi kesalahan saat membuat pelanggan:", error);
    ...
    return (
        <div style={styles.container}>
            <h1 style={styles.header}>Tambah Pelanggan Baru</h1>
